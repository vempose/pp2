...
class Coin(pygame.sprite.Sprite):
    ...
    def respawn(self):
        ...
        # Random worth and size that's depending on it
        self.worth = random.randint(1, 3)
        self.image = pygame.transform.scale_by(self.image, 1 + self.worth / 9)
...
while True:
    ...
    # Enemy speed's dependence on money amount
    ENEMY_SPEED = MONEY // 3 + 1
